...
class ProdConsSU1 : public HoareMonitor
{
 ...
 int                        // variables permanentes
   ...
   num_libres;              //   número de celdas libres en el buffer
...
int ProdConsSU1::leer(  )
{
   ...
   if ( num_libres == num_celdas_total )
      ocupadas.wait();

   cout << "leer: ocupada== " << primera_ocupada << ", total == " << num_celdas_total << endl ;
...
void ProdConsSU1::escribir( int valor )
{
   ...
   cout << "escribir: libre == " << primera_libre << ", total == " << num_celdas_total << endl ;
